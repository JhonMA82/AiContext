...
```sh
curl -LsSf https://raw.githubusercontent.com/JhonMA82/AiContext/main/installers/install.sh | sh -s -- --version 0.4.0
```

Windows:

```powershell
irm https://raw.githubusercontent.com/JhonMA82/AiContext/main/installers/install.ps1 | iex
```
