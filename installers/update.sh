...
Remote usage:
  curl -LsSf https://raw.githubusercontent.com/$REPO/main/installers/update.sh | sh -s -- --check
  curl -LsSf https://raw.githubusercontent.com/$REPO/main/installers/update.sh | sh -s -- --yes
USAGE
}
