...
Remote usage:
  curl -LsSf https://raw.githubusercontent.com/$REPO/v0.7.0/installers/update.sh | sh -s -- --check
  curl -LsSf https://raw.githubusercontent.com/$REPO/v0.7.0/installers/update.sh | sh -s -- --yes
USAGE
}
