...
Remote usage:
  curl -LsSf https://raw.githubusercontent.com/$REPO/v0.7.0/installers/install.sh | sh
  curl -LsSf https://raw.githubusercontent.com/$REPO/v0.7.0/installers/install.sh | sh -s -- --version 0.4.0
